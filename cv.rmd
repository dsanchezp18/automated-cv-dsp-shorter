...
```{r}
if(params$pdf_mode){
  cat("View this CV online with links at _https://github.com/dsanchezp18/automated-cv-dsp/daniel_sanchez_cv_english.html_")
} else {
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/dsanchezp18/automated-cv-dsp/daniel_sanchez_cv_english.pdf)")
}
```
